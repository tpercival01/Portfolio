const projects = [
    ...
    },
    {
        ...
        language: "Python",
        categories: ["python", "ai", "automation", "data"],
        featured: true,
        summary: "AI-assisted support triage prototype that classifies ServiceNow-style tickets, predicts priority, flags security risks, retrieves similar incidents, and generates analyst-style notes via Groq LLM — with evaluation metrics and a Streamlit dashboard.",
        stack: [
            "Python",
            "Streamlit",
            "pandas",
