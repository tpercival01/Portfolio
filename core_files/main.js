...
function timer() {
    ...
    setTimeout(textAnimationProfile, ((Math.floor(Math.random() * 30) + 1) * 1000));
    setTimeout(textAnimationProject, ((Math.floor(Math.random() * 30) + 1) * 1000));
    setTimeout(textAnimationSocial, ((Math.floor(Math.random() * 30) + 1) * 1000));
